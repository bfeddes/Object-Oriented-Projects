...
import java.util.ArrayList;
    ...
    public class SampleArtisticWorks {
        ...
        public static ArrayList<ArtisticWork> generate() {
            ...
            ShortStory story;
            Movie movie;
            // Adding content to songs, poems, etc
            song = new Song("Joe Johnson","October 12, 2022","Unbearable Likeness",
            "A song about unrequited love",181,"unbearablelikeness.wav",12.8,128,"C major");
            song.addComment("Ray Klump","10/13/22","This song hits hard.");
            song.addComment("Mary Johnson","October 15, 2022", "Haunting and raw");
            works.add(song);
            poem = new Poem("Phoebe B.","2022-11-04","Roses Are Blue",
            "A poem about hazy confusion and the meaninglessness of it all.","English",
            "This poem is flowin' like phloem // and I be knowin what be stolen from you.","iambic pentameter");
            ...
            works.add(story);
            movie = new Movie("Steven Yeats","October 15, 2022","Dubliner in Paris",
            "Seamus takes holiday in Paris and hilarity ensues.",137,"dubliner.mp4",182.43,30,"1080p");
